...
boolean debounce1(boolean last){
 boolean current = digitalRead(BTN1); //Read the button state
 if (last != current) //if it's different...
{    delay(5); //wait 5ms
 current = digitalRead(BTN1); //read it again
 }   return current; //return the current value
 }

boolean debounce2(boolean last){
 boolean current = digitalRead(BTN2); //Read the button state
 if (last != current) //if it's different...
{    delay(5); //wait 5ms
 current = digitalRead(BTN2); //read it again
 }   return current; //return the current value
 }

boolean debounce3(boolean last){
 boolean current = digitalRead(BTN3); //Read the button state
 if (last != current) //if it's different...
{    delay(5); //wait 5ms
 current = digitalRead(BTN3); //read it again
 }   return current; //return the current value
 }

boolean debounce4(boolean last){
 boolean current = digitalRead(BTN4); //Read the button state
 if (last != current) //if it's different...
{    delay(5); //wait 5ms
 current = digitalRead(BTN4); //read it again
 }   return current; //return the current value
 }

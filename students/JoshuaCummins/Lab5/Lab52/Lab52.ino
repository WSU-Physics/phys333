...
void loop() {
 ...
 // Serial.print("Accel Z: ");
  ...
  theta_zx = atan(AccelX / AccelZ) * 180.0 / 3.14;
  theta_zy = atan(AccelY / AccelZ) * 180.0 / 3.14;
  Serial.print(theta_zx);
  Serial.print(" ");
  Serial.print(theta_zy);
  Serial.print(" ");
  
  float theta = sqrt(theta_zx * theta_zx + theta_zy * theta_zy);

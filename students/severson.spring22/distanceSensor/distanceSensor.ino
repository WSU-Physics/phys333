 ...
 */
 ...
 SharpIR sensor(SharpIR::GP2Y0A21YK0F, A0);     //assigns pin A0 (analog in) to the sensor (use the correct model #)
...
void loop() {
  ...
  brightness = map(brightness, 9, 81, 255, 0);  //maps brightness for analogWrite() using the min and max values of distance
